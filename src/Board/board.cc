...
//        print_chess_board();
        ...
        for (size_t i = 0; i < moves.size(); ++i) {
            ...
            if (piece->get_type() == Type::pawn && move.isDouble1()) {
                if(check_border(piece->get_x(),piece->get_y() + 1) && chessBoard_[piece->get_x()][piece->get_y()+1] != nullptr
                    &&  chessBoard_[piece->get_x()][piece->get_y()+1]->get_type() == Type::pawn && chessBoard_[piece->get_x()][piece->get_y()+1]->get_color() != player_to_move_)
                {
